      ...
      <div className="glass-panel" style={styles.mainPanel}>
        ...
        {loading ? (
          ...
          <div style={styles.grid}>
            {groups.map(group => (
              <div key={group.id} className="glass-panel" style={styles.card}>
                <div style={styles.cardTop}>
                  <div style={styles.groupBadge}>{group.nombre}</div>
                  <div style={styles.cardActions}>
                    <button onClick={() => handleOpenForm(group)} className="btn-icon">
                      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                    </button>
                    <button onClick={() => handleConfirmDelete(group)} className="btn-delete" title="Eliminar">
                ...
                <div style={styles.cardInfo}>
                  <h3 style={styles.titulacionName}>{group.titulacionNombre}</h3>
                  <div style={styles.meta}>
                    <span style={styles.metaBadge}>{group.curso}º Curso</span>
                    <span style={styles.metaYear}>{group.cursoAcademicoNombre}</span>
                  </div>
                  <div style={styles.deptInfo}>
                    <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle></svg>
                    {group.departamento}
                  </div>
                </div>
              </div>
