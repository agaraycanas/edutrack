        ...
        {loading ? (
          ...
          <div style={styles.subjectGrid}>
            {subjects.map(subject => (
              <div key={subject.id} className="subject-card" style={styles.subjectCard}>
                <div style={styles.cardHeader}>
                  ...
                  <div style={styles.cardActions}>
                    <button 
                      ...
                      title="Editar"
                    >
                      <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                    </button>
                    <button 
                ...
                <div style={styles.cardBody}>
                  <h3 style={styles.subjectName}>{subject.nombre}</h3>
                  <div style={styles.subjectMeta}>
                    <span style={styles.metaItem}>
                      <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>
                      {subject.curso}º Curso
                    </span>
                    <span style={styles.metaItem}>
                      <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
