...
export default function AcademicYears() {
  ...
  return (
    <div className="animate-fade-in">
      <h1 style={{ marginBottom: '2rem' }}>Configuración del Curso Académico</h1>

      <div style={styles.grid}>
        {/* Formulario de creación */}
        <div className="glass-panel" style={styles.card}>
          <h2 style={{ fontSize: '1.25rem', marginBottom: '1.5rem' }}>Nuevo Curso</h2>
...
const styles = {
  ...
  deleteBtn: {
    background: 'transparent', border: 'none', color: '#ef4444', cursor: 'pointer', padding: '8px', borderRadius: '4px', transition: 'background 0.2s'
  }
};
